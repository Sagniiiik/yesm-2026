          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              {eventsList.map((event) => (
                <div 
                  key={event.name} 
                  className={`bg-[#F8F5F2] border ${expandedEvent === event.name ? 'border-[#732021] shadow-md' : 'border-[#D9D2C5]'} rounded-md p-6 hover:border-[#732021] transition-all duration-300 cursor-pointer flex flex-col`}
                ...
                >
                  ...
                  {expandedEvent === event.name ? (
                    <div className="mt-auto pt-4 border-t border-[#D9D2C5]">
